...
| :-------:| :-------: | :---------: |:-----------: | :------: | 
|MODULE 1 |[Basic Architecture]([https://github.com/deepanshudashora/ERAV1/blob/master/session6/part1/README.md](https://github.com/deepanshudashora/ERAV1/blob/master/session7/Module%201%20(Basics%20Done)/Basic_skelaton/S7_Base_architecture.ipynb))|7,964|99.25%| . The Base target is to make a architecture which has less than 8000 parameters, In this stage we do not consider any points for accuracy, Batch Normalization is alredy done since we know we need to introduce it furture.  |
||Dropout Introduced|7,964|99.29%| Since the model is overfitting, it's time to introduce dropout, after few experiments, the correct dropout value was found and model was stable|
|MODULE 2|Transition Block Location|7,824|99.35%| Changing the pooling layer location and transition block location helps a lot in learning of network, compare with Module1 architecture, this time the maxpooling is used after 5x5 receptive field which changed the game|
...
|MODULE 3|Data Augmentation|7,824|99.50%| The Limits are pushed furture and data augmentation is added, This lead to the best testing accuracy of this experiment |
||Final Submission|6,084|99.45%| Since model parameters are so close to 8000, time to reduce them even more, and it was successful, finally 99.45 is achived |
...
|Transition Block|conv3 |  6 |  12|  2 |  1 |  0 |  3  | 10 | 10 | 2  | 
||conv4 |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |
|Convolution Block|conv5 |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |
||conv6 |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |
|Convolution Block|conv7 |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |
||conv8 |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |
|Global Average Pooling|GAP |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |
| 1x1 |conv9 |  10 | 10| 2  | 1  | 0  | 3  | 14 | 8|   2  |

...
class Net(nn.Module):
    def __init__(self,norm_type):
        ...
        self.convblock2 = nn.Sequential(
            ...
            get_norm_layer(20,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(20, 22, (3, 3), padding=1, bias=False),  
            nn.ReLU(),
            get_norm_layer(22,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(22, 20, (3, 3), padding=1, bias=False),  
            nn.ReLU(),
            get_norm_layer(20,norm_type),
            nn.Dropout(drop)
        ) 
        ...
        self.trans2 = nn.Sequential(
            nn.Conv2d(20, 18, (3, 3), padding=1, bias=False), 
            nn.ReLU(),
        ...
        self.convblock3 = nn.Sequential(
            nn.Conv2d(18, 24, (3, 3), padding=1, bias=False),  
            nn.ReLU(),
            get_norm_layer(24,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(24, 22, (3, 3), padding=0, bias=False),  
            nn.ReLU(),
            get_norm_layer(22,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(22, 24, (3, 3), padding=0, bias=False),  
            nn.ReLU(),
            get_norm_layer(24,norm_type),
            nn.Dropout(drop)
        ) 
        ...
        self.convblock4 = nn.Sequential(
            nn.Conv2d(24, 10, (1, 1), padding=0, bias=False),  
        )

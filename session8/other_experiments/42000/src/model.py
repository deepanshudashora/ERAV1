...
class Net(nn.Module):
    def __init__(self,norm_type):
        ...
        self.convblock2 = nn.Sequential(
            ...
            get_norm_layer(20,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(20, 28, (3, 3), padding=1, bias=False),  
            nn.ReLU(),
            get_norm_layer(28,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(28, 32, (3, 3), padding=1, bias=False),  
            nn.ReLU(),
            get_norm_layer(32,norm_type),
            nn.Dropout(drop)
        ) 
        ...
        self.convblock3 = nn.Sequential(
            nn.Conv2d(20, 24, (3, 3), padding=1, bias=False),  
            nn.ReLU(),
            get_norm_layer(24,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(24, 28, (3, 3), padding=0, bias=False),  
            nn.ReLU(),
            get_norm_layer(28,norm_type),
            nn.Dropout(drop),
            nn.Conv2d(28, 32, (3, 3), padding=0, bias=False),  
            nn.ReLU(),
            get_norm_layer(32,norm_type),
            nn.Dropout(drop)
        ) 
        ...
        self.convblock4 = nn.Sequential(
            nn.Conv2d(32, 10, (1, 1), padding=0, bias=False),  
        )
